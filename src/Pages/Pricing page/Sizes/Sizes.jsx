            ...
            <div className="Sizes">
                <div className="Sizes_Main">
                    <div className="Sizes_top">
                        ...
                        <h1>Pricing built to suits teams <br /> of all sizes</h1>
                    ...
                    <div className="Sizes_bottom_row">
                        <div className="Sizes_bottom_first">
                            ...
                            <div className="Sizes_bottom_two">
                                ...
                                <p>Add Soem details here to describe <br /> the type of plan and its particular benefits   </p>
                            </div>
                            <div className="Sizes_bottom_three">
                                <span> <img src={Sizeschecked} alt="" />
                                    <h1> All limited links</h1></span>
                                <span>        <img src={Sizeschecked} alt="" />
                                    <h1> Own analytics Platform</h1></span>
                                <span>     <img src={Sizeschecked} alt="" />
                                    <h1>
                                        Unlimited users</h1></span>

                                <span>          <img src={Sizeschecked} alt="" />
                                    <h1>
                                        Chat support</h1></span>
                                <span>
                                    <img src={Sizeschecked} alt="" />
                                    <h1>
                                        Optimize hashtags</h1></span>
                            </div>
